        ...
        $.ajax({
            ...
            success: function(result) { 
                ...
                for(var i=0; i<result.result.players.length ;i++){
                 ...
                 var graph =('<script>'+
                 'var ctx = document.getElementById("TeamDeal'+target+'");'+
                 'var TeamDeal'+target+' = new Chart(ctx, {'+
                 'type: "pie",'+
                 'data: {'+
                  '   labels: ["승리팀", "패배팀"],'+
                     'datasets: [{'+
                 ...
                 graph +=('<script>'+
                 'var ctx = document.getElementById("TeamDamaged'+target+'");'+
                 'var TeamDamaged'+target+' = new Chart(ctx, {'+
                 'type: "pie",'+
                 'data: {'+
                  '   labels: ["승리팀", "패배팀"],'+
                     'datasets: [{'+
                 ...
                 graph +=('<script>'+
                 'var ctx = document.getElementById("TeamBattleP'+target+'");'+
                 'var TeamBattleP'+target+' = new Chart(ctx, {'+
                 'type: "pie",'+
                 'data: {'+
                  '   labels: ["승리팀", "패배팀"],'+
                     'datasets: [{'+
                ...
                graph +=('<script>'+
                 'var ctx = document.getElementById("TeamSightP'+target+'");'+
                 'var TeamSightP'+target+' = new Chart(ctx, {'+
                 'type: "pie",'+
                 'data: {'+
                  '   labels: ["승리팀", "패배팀"],'+
                     'datasets: [{'+
                ...
                var total = ('<li class="list-group-item list-group-item-light"><ul class="nav nav-tabs" role="tablist" id="myTab">'+
                        '<li class="nav-item"> <a class="nav-link active" id="total-tab" data-toggle="tab" href="#total'+target+'" role="tab" aria-controls="total" aria-selected="true">종합</a></li>'+
                         '<li class="nav-item"><a class="nav-link" id="item-tab" data-toggle="tab" href="#item'+target+'" role="tab" aria-controls="item" aria-selected="false">아이템</a></li>'+
						 '<li class="nav-item"><a class="nav-link" id="team-tab" data-toggle="tab" href="#team'+target+'" role="tab" aria-controls="team" aria-selected="false">팀 통계</a></li>'+
				'</ul><div class="tab-content" id="myTabContent">');
                
                total +=('<div role="tabpanel" class="tab-pane fade" id="team'+target+'" aria-labelledby="team-tab"><br><div class="row">'+
                ...
                '<div class="card-body"><canvas id="TeamDeal'+target+'" width="100%" height="50"></canvas></div><a class="text-center">승리팀 : '+(winTeamDeal/1000).toFixed(0)+'K<br>패배팀 : '+(loseTeamDeal/1000).toFixed(0)+'K</a></div> </div>'+
                '<div class="col-md-6 col-lg-6 col-sm-6 col-xs-6"> <div class="card mb-4">'+
                '<div class="card-header" data-toggle="tooltip" data-placement="bottom" ><i class="fas fa-chart-pie mr-1"></i>받은 피해량</div>'+
                '<div class="card-body"><canvas id="TeamDamaged'+target+'" width="100%" height="50"></canvas></div><a class="text-center">승리팀 : '+(winTeamDamaged/1000).toFixed(0)+'K<br>패배팀 : '+(loseTeamDamaged/1000).toFixed(0)+'K</a></div> </div>'+
                '<div class="col-md-6 col-lg-6 col-sm-6 col-xs-6"> <div class="card mb-4">'+
                '<div class="card-header" data-toggle="tooltip" data-placement="bottom" ><i class="fas fa-chart-pie mr-1"></i>전투 참여</div>'+
                '<div class="card-body"><canvas id="TeamBattleP'+target+'" width="100%" height="50"></canvas></div><a class="text-center">승리팀 : '+winTeamBattleP+'점<br>패배팀 : '+loseTeamBattleP+'점</a></div> </div>'+
                '<div class="col-md-6 col-lg-6 col-sm-6 col-xs-6"> <div class="card mb-4">'+
                '<div class="card-header" data-toggle="tooltip" data-placement="bottom" ><i class="fas fa-chart-pie mr-1"></i>시야 확보</div>'+
                '<div class="card-body"><canvas id="TeamSightP'+target+'" width="100%" height="50"></canvas></div><a class="text-center">승리팀 : '+winTeamSightP+'점<br>패배팀 : '+loseTeamSightP+'점</a></div> </div></div></div>');
                total += graph;
                total += ('<div role="tabpanel" class="tab-pane fade active show" id="total'+target+'" aria-labelledby="total-tab">'+
             ...
             for(var i=0; i<result.result.players.length ;i++)
                ...
                total+='</table></div><div role="tabpanel" class="tab-pane fade" id="item'+target+'" aria-labelledby="item-tab">'          
